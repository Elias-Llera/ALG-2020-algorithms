...
public class ClosestPointsTest {
	...
	public void testCase01() {
		...
		closest.loadPoints("src/main/java/session3/closest/case1.txt");
		closest.printPoints();
		...
		assertEquals(String.valueOf(pairBruteForce.getDistance()), String.valueOf(pairDAndC.getDistance()));
	}

	@Test
	public void testCase02() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/session3/closest/case2.txt");
		closest.printPoints();
	...
	public void testCase03() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/session3/closest/case3.txt");
		closest.printPoints();
	...
	public void testCase04() {
		ClosestPoints closest = new ClosestPoints();
		closest.loadPoints("src/main/java/session3/closest/case4.txt");
		closest.printPoints();
	...
	public void testCase05() {
		for (int n = 10; n < Integer.MAX_VALUE; n *= 2) {
			...
			System.out
					.println("n=" + n + " - Solution with brute force: " + pairBruteForce + " in " + (t2 - t1) + "ms");
